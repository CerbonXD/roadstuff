...
public class RSNetwork
{
    ...
    {
        ROADSTUFF_CHANNEL.messageBuilder(BrushPacket.class, 0).encoder(BrushPacket::encode).decoder(BrushPacket::decode).consumerNetworkThread(BrushPacket::handle).add();
    }
}